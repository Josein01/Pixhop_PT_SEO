    ...
    >
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        <h1 className="text-5xl font-extrabold tracking-tight text-gray-100 sm:text-6xl md:text-7xl">
          {t('start.title')}<span className="text-blue-400">{t('start.title.emphasis')}</span>.
        </h1>
        ...
        <div className="mt-6 flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-gray-500">{t('start.orDragDrop')}</p>
        </div>
        ...
        <div className="mt-16 w-full">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-gray-100">{t('start.card.retouch.title')}</h3>
              <p className="mt-2 text-gray-400">{t('start.card.retouch.body')}</p>
            </div>
            ...
            <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-gray-100">{t('start.card.filters.title')}</h3>
              <p className="mt-2 text-gray-400">{t('start.card.filters.body')}</p>
            </div>
            ...
            <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-gray-100">{t('start.card.adjust.title')}</h3>
              <p className="mt-2 text-gray-400">{t('start.card.adjust.body')}</p>
            </div>
          </div>
        </div>
